...
internal class VivoBuiltIn
{
    ...
    public System.Func<string, MaterialProperty[], MaterialProperty> findProperty3Fun;
    public System.Func<string, MaterialProperty[], bool, MaterialProperty> findProperty4Fun;

    public void FindProperties(MaterialProperty[] props)
    {
        blendMode = findProperty3Fun("_Mode", props);
        albedoMap = findProperty3Fun("_BaseMap", props);
        albedoColor = findProperty3Fun("_BaseColor", props);
        alphaCutoff = findProperty3Fun("_Cutoff", props);
        specularMap = findProperty4Fun("_SpecGlossMap", props, false);
        specularColor = findProperty4Fun("_SpecColor", props, false);
        metallicMap = findProperty4Fun("_MetallicGlossMap", props, false);
        metallic = findProperty4Fun("_Metallic", props, false);
        ...
        smoothness = findProperty3Fun("_Smoothness", props);
        smoothnessScale = findProperty4Fun("_GlossMapScale", props, false);
        smoothnessMapChannel = findProperty4Fun("_SmoothnessTextureChannel", props, false);
        highlights = findProperty4Fun("_SpecularHighlights", props, false);
        reflections = findProperty4Fun("_GlossyReflections", props, false);
        bumpScale = findProperty3Fun("_BumpScale", props);
        bumpMap = findProperty3Fun("_BumpMap", props);
        heigtMapScale = findProperty3Fun("_Parallax", props);
        heightMap = findProperty3Fun("_ParallaxMap", props);
        occlusionStrength = findProperty3Fun("_OcclusionStrength", props);
        occlusionMap = findProperty3Fun("_OcclusionMap", props);
        emissionColorForRendering = findProperty3Fun("_EmissionColor", props);
        emissionMap = findProperty3Fun("_EmissionMap", props);
        detailMask = findProperty3Fun("_DetailMask", props);
        detailAlbedoMap = findProperty3Fun("_DetailAlbedoMap", props);
        detailNormalMapScale = findProperty3Fun("_DetailNormalMapScale", props);
        detailNormalMap = findProperty3Fun("_DetailNormalMap", props);
        uvSetSecondary = findProperty3Fun("_UVSec", props);
    }

    public void SetOnGUI(MaterialEditor materialEditor, MaterialProperty[] props,
        System.Func<string, MaterialProperty[], MaterialProperty> _findProperty3Fun,
        System.Func<string, MaterialProperty[], bool, MaterialProperty> _findProperty4Fun)
    {
        findProperty3Fun = _findProperty3Fun;
        findProperty4Fun = _findProperty4Fun;
