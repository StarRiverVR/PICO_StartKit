...
#ifndef BUILT_IN_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
#define BUILT_IN_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
...
VertexOutputBaseSimple vertForwardBaseSimple (VertexInput v)
{
    ...
    #if !GLOSSMAP
        o.eyeVec.w = saturate(_Smoothness + UNIFORM_REFLECTIVITY()); // grazing term
    #endif
...
#endif // BUILT_IN_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
